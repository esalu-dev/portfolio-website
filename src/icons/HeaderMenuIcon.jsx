...
export function HeaderMenuIcon(){
   ...
   return(
      <button onClick={toggleMenu} className={`${menuActive ? 'absolute top-4 right-20' : ''} sm:hidden rounded-full flex justify-center items-center hover:bg-white hover:bg-opacity-10 hover:rotate-45 transition-transform active:bg-opacity-5 duration-150 ease-in-out w-10 h-10`}>
