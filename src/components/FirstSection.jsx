...
export function FirstSection(){
   return(
      <section className="w-full h-[600px] flex flex-col items-center pt-10">
         ...
         <aside className="text-center mt-14 mb-6">
            ...
            <h3 className="dark:text-pastel-green font-bold text-pastel-green-900 text-2xl">Front-End Developer</h3>
         </aside>
