...
export function Card({title, imgURL, contentFirstButton, linkFirstButton, contentSecondButton, linkSecondButton}) {
   ...
   return(
      <div onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave} className="relative flex flex-col border-4 dark:border-light-green-600 border-pastel-green-800 dark:bg-emerald-900 dark:text-white bg-pastel-green rounded-md shadow-lg max-w-xs ">
